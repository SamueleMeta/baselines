...
def learn(env, make_policy, *,
    ...
    losses_with_name.append((tf.reduce_sum(behavioral_log_pdfs_split[0][0]), 'BpdfMean0'))
    losses_with_name.append((tf.reduce_min(behavioral_log_pdfs_split[0][0]), 'BpdfMin0'))
