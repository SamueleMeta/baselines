...
from baselines.pgpe import npgpe
...
def train(env, policy, horizon, seed,
    ...
    # Learn
    print(alg_args)
    npgpe.learn(make_env, seed, make_policy, horizon=horizon, **alg_args)
...
def single_run(args, seed=None):
    ...
    train(env=args.env,
          ...
          step_size_strategy=args.step_size_strategy,
...
def main(args):
    ...
    parser.add_argument('--std_init', type=float, default=None)
    ...
    parser.add_argument('--step_size_strategy', type=str, default=None)
    add_bool_arg(parser, 'trainable_std', default=False)
    add_bool_arg(parser, 'experiment', default=False)
    add_bool_arg(parser, 'use_baseline', default=False)
