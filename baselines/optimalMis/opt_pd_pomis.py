...
def learn(make_env, make_policy, *,
    ...
    if iw_method == 'is':
        ...
        losses_with_name.extend([(tf.reduce_max(divergence_0t), 'MaxDivergence0t'),
                                 (tf.reduce_min(divergence_0t), 'MinDivergence0t'),
                                 (tf.reduce_mean(divergence_0t), 'MeanDivergence0t'),
                                 (U.reduce_std(divergence_0t), 'StdDivergence0t')])
    else:
    ...
    elif bound == 'pdis-max-divergence':
        if penalization:
            if gamma == 1:
