...
def train(env, max_iters, num_episodes, horizon, iw_method, iw_norm, natural, bound, delta, seed, policy, max_offline_iters, njobs=1):
    ...
    ncpu = 2#len(os.sched_getaffinity(0))
    ...
    def make_policy(name, sess, ob_space, ac_space, nbatch):
        return MlpPolicy(name=name, sess=sess, ob_space=ob_space, ac_space=ac_space, nbatch=nbatch,
    ...
    pois3.learn(parallel_env, make_policy, n_episodes=num_episodes, max_iters=500,
