    ...
    def __init__(self, env_fns, spaces=None, terminating=False):
        ...
        for env_fn, obs_buf in zip(env_fns, self.obs_bufs):
            ...
            proc = Process(target=_subproc_worker,
                           args=(child_pipe, parent_pipe, wrapped_fn, obs_buf, self.obs_shapes, self.obs_dtypes, self.obs_keys, terminating))
            proc.daemon = True
...
def _subproc_worker(pipe, parent_pipe, env_fn_wrapper, obs_bufs, obs_shapes, obs_dtypes, keys, terminating):
    """
